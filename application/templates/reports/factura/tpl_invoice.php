...
<page backcolor="#FEFEFE" backimgx="center" 
      backimgy="bottom" backimgw="100%" backtop="10mm" 
      backleft="10mm" backright="10mm" backbottom="30mm" footer="date;time;page" 
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
        <tr>
            <td style="width:50%;">contratante</td>
            <td style="width:14%; ">Client :</td>
            <td style="width:36%">M. Albert Dupont</td>
        </tr>
        <tr>
            <td style="width:50%;">cif contratante</td>
            <td style="width:14%; ">CIF :</td>
            <td style="width:36%">sdsd</td>
        </tr>
        <tr>
            <td style="width:50%;">direccion contratante</td>
        ...
        <tr>
            <td style="width:50%;">Email contratante</td>
            <td style="width:14%; ">Email :</td>
            <td style="width:36%">nomail@domain.com</td>
        </tr>
        <tr>
            <td style="width:50%;">telefono contratante</td>
    ...
    <br>
    <br>
    Nous souhaitons vous informer que le dossier <b>71326</b> concernant un &laquo; Bon de Retour &raquo; 
    pour les articles suivants a été accepté.<br>
    <br>

<div id="page-wrapper">
    <h2>fac2fast/empresa/Edit record</h2>
    <form action="http://local.factufacil/fac2fast/empresa/update/<?php echo $rs->id_empresa; ?>" 
...
<div class='col-sm-6'> 
 <div class='input-group col-sm-8'> 
<input type="text" id="f_empresa" name="f_empresa" class="form-control"  maxlength="45"  value="<?php echo $rs->empresa;?>"  />
 </div> 
 </div> 
</div> 
<div class='form-group form-group-sm'> 
...
<div class='col-sm-6'> 
 <div class='input-group col-sm-8'> 
<input type="text" id="f_direccion" name="f_direccion" class="form-control"  maxlength="150"  value="<?php echo $rs->direccion;?>"  />
 </div> 
 </div> 
</div> 
<div class='form-group form-group-sm'> 
...
<div class='col-sm-6'> 
 <div class='input-group col-sm-8'> 
<input type="text" id="f_observacion" name="f_observacion" class="form-control"  maxlength="150"  value="<?php echo $rs->observacion;?>"  />
 </div> 
 </div> 
</div> 
<div class='form-group form-group-sm'> 

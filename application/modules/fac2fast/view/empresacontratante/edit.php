<div id="page-wrapper">
    <h2>fac2fast/empresacontratante/Edit record</h2>
    <form action="http://local.factufacil/fac2fast/empresacontratante/update/<?php echo $rs->id_empresa; ?>" 
...
<div class='col-sm-6'> 
 <div class='input-group col-sm-8'> 
<input type="text" id="f_fechas" name="f_fechas" class="form-control"  maxlength="45"  value="<?php echo $rs->fechas;?>"  />
 </div> 
 </div> 
</div> 

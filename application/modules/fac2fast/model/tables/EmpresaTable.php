...
$_aux_estados_id_estado,
     ...
     public function __construct()
    {
        ...
        $this->_query = ' SELECT A.id_empresa,A.cif,A.empresa,A.razon_social,A.id_poblacion,A.direccion,A.telefono,A.email,A.contacto,A.cta_bancaria,A.observacion,A.created_at,A.created_by,A.aux_estados_id_estado,B.estado,B.tipo,C.poblacion,C.provincia,C.ccaa,C.pais,C.cod_poblacion,C.cod_provincia,C.cod_ccaa,C.cod_pais' 
.' FROM a_empresas A '

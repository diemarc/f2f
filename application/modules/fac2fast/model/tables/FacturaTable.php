...
abstract class FacturaTable extends \kerana\Ada {
    ...
    public function __construct() {
        ...
        $this->_query = ' SELECT A.id_facturas,A.id_empresa,A.id_contratante,'
                ...
                . ' B2.aux_estados_id_estado AS id_estado_contratante,B23.estado AS estado_contratante,'
                . ' B23.tipo AS tipo_estado_contratante, B24.poblacion AS poblacion_contratante,'
                ...
                . ' B3.aux_estados_id_estado,B34.estado,B34.tipo,B35.poblacion,B35.provincia,B35.ccaa,B35.pais,'
                ...
                . ' INNER JOIN aux_estados B23 ON (B23.id_estado = B2.aux_estados_id_estado) '
                . ' INNER JOIN aux_poblaciones B24 ON (B24.id_poblacion = B2.id_poblacion) '
                . ' INNER JOIN a_empresas B3 ON (B3.id_empresa = B.id_empresa) '
                . ' INNER JOIN aux_estados B34 ON (B34.id_estado = B3.aux_estados_id_estado) '

...
/*
  |-----------------------------------------------------------------------------
  | Class ServiciosTasaTable
  |-----------------------------------------------------------------------------
  |
  | Persistance layer for f_servicios_tasas
  | @author kerana,
  | @date 19-03-2018 17:31:45,
  |
 */

abstract class ServiciosTasaTable extends \kerana\Ada {
...
$_id_tasa,
            ...
            /** Master query for serviciostasa */
            $_query_serviciostasa;
...
.' INNER JOIN aux_clases C34 ON (C34.id_clases = C3.id_clases) ' 
 ...
 .' WHERE A.id_servicio IS NOT NULL ';  
    ...
    */
     ...
     * @return boolean
     */
    public function saveServiciosTasa(){
